...
-- Дата скрипта: 12.04.2021 4:43:54
...
--
-- Таблица portfolio.wp_woocommerce_downloadable_product_permissions не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_tax_rate_locations
--
-- Таблица portfolio.wp_woocommerce_tax_rate_locations не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_tax_rates
--
-- Таблица portfolio.wp_woocommerce_tax_rates не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_shipping_zone_methods
--
-- Таблица portfolio.wp_woocommerce_shipping_zone_methods не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_shipping_zone_locations
--
-- Таблица portfolio.wp_woocommerce_shipping_zone_locations не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_shipping_zones
--
-- Таблица portfolio.wp_woocommerce_shipping_zones не содержит данных
...
--
-- Таблица portfolio.wp_woocommerce_payment_tokens не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_payment_tokenmeta
--
-- Таблица portfolio.wp_woocommerce_payment_tokenmeta не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_order_items
--
-- Таблица portfolio.wp_woocommerce_order_items не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_order_itemmeta
--
-- Таблица portfolio.wp_woocommerce_order_itemmeta не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_log
--
-- Таблица portfolio.wp_woocommerce_log не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_attribute_taxonomies
--
-- Таблица portfolio.wp_woocommerce_attribute_taxonomies не содержит данных

-- 
-- Вывод данных для таблицы wp_woocommerce_api_keys
--
-- Таблица portfolio.wp_woocommerce_api_keys не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_webhooks
--
-- Таблица portfolio.wp_wc_webhooks не содержит данных
...
--
-- Таблица portfolio.wp_wc_reserved_stock не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_product_meta_lookup
--
-- Таблица portfolio.wp_wc_product_meta_lookup не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_order_tax_lookup
--
-- Таблица portfolio.wp_wc_order_tax_lookup не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_order_stats
--
-- Таблица portfolio.wp_wc_order_stats не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_order_product_lookup
--
-- Таблица portfolio.wp_wc_order_product_lookup не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_order_coupon_lookup
--
-- Таблица portfolio.wp_wc_order_coupon_lookup не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_download_log
--
-- Таблица portfolio.wp_wc_download_log не содержит данных

-- 
-- Вывод данных для таблицы wp_wc_customer_lookup
--
-- Таблица portfolio.wp_wc_customer_lookup не содержит данных
...
(1, 'alphaadmin', '$P$BdFQre4UtJhgJqZaWyj9j8kfXmLaYE.', 'alphaadmin', 'admin@portfolio.loc', 'http://portfolio.loc', '2021-03-21 19:32:36', '', 0, 'alphaadmin');
...
(16, 1, 'session_tokens', 'a:5:{s:64:"50f8591064c9042ecf9ec0ea39afe7505f1ba316951a5ad79ea4a95520afb2c6";a:4:{s:10:"expiration";i:1618209628;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:77:"Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0";s:5:"login";i:1617000028;}s:64:"91e0fce37330e24806b87187dcf060f00a654e312d9c6adc1ceaadfec4ff980d";a:4:{s:10:"expiration";i:1618297134;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:77:"Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0";s:5:"login";i:1617087534;}s:64:"e4a28396dc052df984870133e3ec574ddbc9a259c12ea169f9aa70b6528df2fd";a:4:{s:10:"expiration";i:1618114570;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:77:"Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:87.0) Gecko/20100101 Firefox/87.0";s:5:"login";i:1617941770;}s:64:"d41dbd195adeca45667d5ae9c602fcdce9b5e4784b5e174d221e0d60b5ce9550";a:4:{s:10:"expiration";i:1618141372;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:132:"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Safari/537.36 OPR/73.0.3856.344";s:5:"login";i:1617968572;}s:64:"adf3500c83206fc4d2c3d65f353f0b62ddbde3a6a658146c49f3acfd2d2778f2";a:4:{s:10:"expiration";i:1618163888;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:131:"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36 OPR/75.0.3969.149";s:5:"login";i:1617991088;}}'),
...
(20, 1, '2021-03-23 14:01:21', '2021-03-23 11:01:21', '{\n    "blogdescription": {\n        "value": "\\u0421\\u0430\\u0439\\u0442 \\u0441\\u0434\\u0435\\u043b\\u0430\\u043d \\u043d\\u0430 WordPress \\u0434\\u043b\\u044f \\u0446\\u0435\\u043b\\u0435\\u0439 \\u043e\\u0431\\u0443\\u0447\\u0435\\u043d\\u0438\\u044f",\n        "type": "option",\n        "user_id": 1,\n        "date_modified_gmt": "2021-03-23 11:01:21"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '9f408c20-137e-4e19-ae61-1605582522f5', '', '', '2021-03-23 14:01:21', '2021-03-23 11:01:21', '', 0, 'http://portfolio.loc/2021/03/23/9f408c20-137e-4e19-ae61-1605582522f5/', 0, 'customize_changeset', '', 0),
(21, 1, '2021-03-23 14:01:39', '2021-03-23 11:01:39', '{\n    "childhood::custom_logo": {\n        "value": 17,\n        "type": "theme_mod",\n        "user_id": 1,\n        "date_modified_gmt": "2021-03-23 11:01:39"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '538eb3c2-24d5-4e65-a37a-8a1560182cf7', '', '', '2021-03-23 14:01:39', '2021-03-23 11:01:39', '', 0, 'http://portfolio.loc/2021/03/23/538eb3c2-24d5-4e65-a37a-8a1560182cf7/', 0, 'customize_changeset', '', 0),
(22, 1, '2021-03-24 14:32:23', '2021-03-24 11:32:23', 'a:7:{s:8:"location";a:2:{i:0;a:1:{i:0;a:3:{s:5:"param";s:4:"page";s:8:"operator";s:2:"==";s:5:"value";s:2:"91";}}i:1;a:1:{i:0;a:3:{s:5:"param";s:13:"post_category";s:8:"operator";s:2:"==";s:5:"value";s:14:"category:navyk";}}}s:8:"position";s:6:"normal";s:5:"style";s:7:"default";s:15:"label_placement";s:3:"top";s:21:"instruction_placement";s:5:"label";s:14:"hide_on_screen";s:0:"";s:11:"description";s:0:"";}', 'Мои навыки', 'moi-navyki', 'publish', 'closed', 'closed', '', 'group_605b21448a1db', '', '', '2021-03-29 10:40:01', '2021-03-29 07:40:01', '', 0, 'http://portfolio.loc/?post_type=acf-field-group&#038;p=22', 0, 'acf-field-group', '', 0),
...
(54, 1, '2021-03-25 08:54:10', '2021-03-25 05:54:10', '', 'Я уже кое что умею делать на WordPress', '', 'publish', 'open', 'open', '', 'ya-uzhe-koe-chto-umeyu-delat-na-wordpress', '', '', '2021-03-25 09:53:43', '2021-03-25 06:53:43', '', 0, 'http://portfolio.loc/?p=54', 0, 'post', '', 0),
...
(56, 1, '2021-03-25 08:56:17', '2021-03-25 05:56:17', '', 'Мои планы на будущее', '', 'publish', 'open', 'open', '', 'moi-plany-na-budushhee', '', '', '2021-03-25 09:52:28', '2021-03-25 06:52:28', '', 0, 'http://portfolio.loc/?p=56', 0, 'post', '', 0),
...
(62, 1, '2021-03-25 09:01:21', '2021-03-25 06:01:21', '', 'MySQL', '', 'publish', 'open', 'open', '', 'mysql', '', '', '2021-03-25 10:36:52', '2021-03-25 07:36:52', '', 0, 'http://portfolio.loc/?p=62', 0, 'post', '', 0),
...
(125, 1, '2021-03-31 23:41:25', '2021-03-31 20:41:25', '', 'Магазин', '', 'trash', 'closed', 'closed', '', 'shop__trashed', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 0, 'https://portfolio.loc/shop/', 0, 'page', '', 0),
(127, 1, '2021-03-31 23:41:25', '2021-03-31 20:41:25', '<!-- wp:shortcode -->[woocommerce_cart]<!-- /wp:shortcode -->', 'Корзина', '', 'trash', 'closed', 'closed', '', 'cart__trashed', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 0, 'https://portfolio.loc/cart/', 0, 'page', '', 0),
(129, 1, '2021-03-31 23:41:25', '2021-03-31 20:41:25', '<!-- wp:shortcode -->[woocommerce_checkout]<!-- /wp:shortcode -->', 'Оформление заказа', '', 'trash', 'closed', 'closed', '', 'checkout__trashed', '', '', '2021-04-05 10:14:51', '2021-04-05 07:14:51', '', 0, 'https://portfolio.loc/checkout/', 0, 'page', '', 0),
(131, 1, '2021-03-31 23:41:26', '2021-03-31 20:41:26', '<!-- wp:shortcode -->[woocommerce_my_account]<!-- /wp:shortcode -->', 'Мой аккаунт', '', 'trash', 'closed', 'closed', '', 'my-account__trashed', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 0, 'https://portfolio.loc/my-account/', 0, 'page', '', 0),
...
(140, 1, '2021-04-04 21:22:25', '0000-00-00 00:00:00', '', 'Черновик', '', 'auto-draft', 'open', 'open', '', '', '', '', '2021-04-04 21:22:25', '0000-00-00 00:00:00', '', 0, 'https://portfolio.loc/?p=140', 0, 'post', '', 0),
...
(142, 1, '2021-04-05 10:14:50', '2021-04-05 07:14:50', '<!-- wp:shortcode -->[woocommerce_cart]<!-- /wp:shortcode -->', 'Корзина', '', 'inherit', 'closed', 'closed', '', '127-revision-v1', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 127, 'https://portfolio.loc/?p=142', 0, 'revision', '', 0),
(143, 1, '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 'Магазин', '', 'inherit', 'closed', 'closed', '', '125-revision-v1', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 125, 'https://portfolio.loc/?p=143', 0, 'revision', '', 0),
(144, 1, '2021-04-05 10:14:50', '2021-04-05 07:14:50', '<!-- wp:shortcode -->[woocommerce_my_account]<!-- /wp:shortcode -->', 'Мой аккаунт', '', 'inherit', 'closed', 'closed', '', '131-revision-v1', '', '', '2021-04-05 10:14:50', '2021-04-05 07:14:50', '', 131, 'https://portfolio.loc/?p=144', 0, 'revision', '', 0),
(145, 1, '2021-04-05 10:14:51', '2021-04-05 07:14:51', '<!-- wp:shortcode -->[woocommerce_checkout]<!-- /wp:shortcode -->', 'Оформление заказа', '', 'inherit', 'closed', 'closed', '', '129-revision-v1', '', '', '2021-04-05 10:14:51', '2021-04-05 07:14:51', '', 129, 'https://portfolio.loc/?p=145', 0, 'revision', '', 0),
...
(152, 1, '2021-04-09 07:17:38', '0000-00-00 00:00:00', '', 'Черновик', '', 'auto-draft', 'open', 'open', '', '', '', '', '2021-04-09 07:17:38', '0000-00-00 00:00:00', '', 0, 'https://portfolio.loc/?p=152', 0, 'post', '', 0),
...
(38, 20, '_wp_trash_meta_time', '1616497282'),
(39, 21, '_wp_trash_meta_status', 'publish'),
(40, 21, '_wp_trash_meta_time', '1616497299'),
(41, 22, '_edit_last', '1'),
(42, 22, '_edit_lock', '1617003471:1'),
(43, 2, '_edit_lock', '1617973052:1'),
...
(83, 39, '_edit_last', '1'),
(84, 39, '_edit_lock', '1617606584:1'),
(85, 2, 'mail', 'delphiprogrammer@bk.ru'),
...
(176, 1, '_edit_lock', '1616655356:1'),
(179, 1, '_wp_old_slug', '%d0%bf%d1%80%d0%b8%d0%b2%d0%b5%d1%82-%d0%bc%d0%b8%d1%80'),
(180, 54, '_edit_lock', '1616655226:1'),
(183, 56, '_edit_lock', '1616655151:1'),
(186, 58, '_edit_lock', '1617627318:1'),
(189, 60, '_edit_lock', '1617276158:1'),
(192, 62, '_edit_lock', '1616657814:1'),
...
(532, 140, '_edit_lock', '1617560408:1'),
...
(543, 127, '_wp_trash_meta_status', 'publish'),
(544, 127, '_wp_trash_meta_time', '1617606890'),
(545, 127, '_wp_desired_post_slug', 'cart'),
(546, 125, '_wp_trash_meta_status', 'publish'),
(547, 125, '_wp_trash_meta_time', '1617606890'),
(548, 125, '_wp_desired_post_slug', 'shop'),
(549, 131, '_wp_trash_meta_status', 'publish'),
(550, 131, '_wp_trash_meta_time', '1617606890'),
(551, 131, '_wp_desired_post_slug', 'my-account'),
(552, 129, '_wp_trash_meta_status', 'publish'),
(553, 129, '_wp_trash_meta_time', '1617606891'),
(554, 129, '_wp_desired_post_slug', 'checkout'),
(555, 93, '_edit_last', '1'),
...
(1, 'siteurl', 'https://portfolio.loc', 'yes'),
(2, 'home', 'https://portfolio.loc', 'yes'),
(3, 'blogname', 'Моё портфолио', 'yes'),
(4, 'blogdescription', 'Сайт сделан на WordPress для целей обучения', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'admin@portfolio.loc', 'yes'),
...
(108, 'cron', 'a:10:{i:1618029157;a:1:{s:34:"wp_privacy_delete_old_export_files";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"hourly";s:4:"args";a:0:{}s:8:"interval";i:3600;}}}i:1618029689;a:1:{s:33:"wc_admin_process_orders_milestone";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"hourly";s:4:"args";a:0:{}s:8:"interval";i:3600;}}}i:1618029704;a:1:{s:29:"wc_admin_unsnooze_admin_notes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"hourly";s:4:"args";a:0:{}s:8:"interval";i:3600;}}}i:1618039957;a:4:{s:18:"wp_https_detection";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1618083157;a:1:{s:32:"recovery_mode_clean_expired_keys";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1618083176;a:2:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}s:25:"delete_expired_transients";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1618083177;a:1:{s:30:"wp_scheduled_auto_draft_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1618087290;a:1:{s:14:"wc_admin_daily";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1618255957;a:1:{s:30:"wp_site_health_scheduled_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:6:"weekly";s:4:"args";a:0:{}s:8:"interval";i:604800;}}}s:7:"version";i:2;}', 'yes'),
...
(151, 'recently_activated', 'a:1:{s:27:"woocommerce/woocommerce.php";i:1617276216;}', 'yes'),
...
(169, 'current_theme', 'Детский сайт', 'yes'),
...
(180, 'theme_mods_academics', 'a:4:{i:0;b:0;s:18:"nav_menu_locations";a:0:{}s:18:"custom_css_post_id";i:-1;s:16:"sidebars_widgets";a:2:{s:4:"time";i:1616332158;s:4:"data";a:1:{s:19:"wp_inactive_widgets";a:6:{i:0;s:8:"search-2";i:1;s:14:"recent-posts-2";i:2;s:17:"recent-comments-2";i:3;s:10:"archives-2";i:4;s:12:"categories-2";i:5;s:6:"meta-2";}}}}', 'yes'),
(182, 'theme_mods_childhood', 'a:4:{i:0;b:0;s:18:"nav_menu_locations";a:0:{}s:18:"custom_css_post_id";i:-1;s:11:"custom_logo";i:17;}', 'yes'),
(186, '_transient_health-check-site-status-result', '{"good":"16","recommended":"3","critical":"2"}', 'yes'),
(249, 'new_admin_email', 'admin@portfolio.loc', 'yes'),
...
(335, '_site_transient_update_core', 'O:8:"stdClass":4:{s:7:"updates";a:1:{i:0;O:8:"stdClass":10:{s:8:"response";s:6:"latest";s:8:"download";s:63:"https://downloads.wordpress.org/release/ru_RU/wordpress-5.7.zip";s:6:"locale";s:5:"ru_RU";s:8:"packages";O:8:"stdClass":5:{s:4:"full";s:63:"https://downloads.wordpress.org/release/ru_RU/wordpress-5.7.zip";s:10:"no_content";s:0:"";s:11:"new_bundled";s:0:"";s:7:"partial";s:0:"";s:8:"rollback";s:0:"";}s:7:"current";s:3:"5.7";s:7:"version";s:3:"5.7";s:11:"php_version";s:6:"5.6.20";s:13:"mysql_version";s:3:"5.0";s:11:"new_bundled";s:3:"5.6";s:15:"partial_version";s:0:"";}}s:12:"last_checked";i:1617996770;s:15:"version_checked";s:3:"5.7";s:12:"translations";a:0:{}}', 'no'),
...
--
-- Таблица portfolio.wp_commentmeta не содержит данных
...
--
-- Таблица portfolio.wp_actionscheduler_claims не содержит данных
