...
<?php 
              ...
              foreach($posts as $post){
                  setup_postdata($post);
                  ?>
            <div class="intro-section" style="background-image: url('<?php  the_field('slider_img'); ?>">
                <div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus assumenda omnis tempora ullam
                    alias amet eveniet voluptas, incidunt quasi aut officiis porro ad, expedita saepe necessitatibus rem
                    debitis architecto dolore? Nam omnis sapiente placeat blanditiis voluptas dignissimos, itaque fugit
                    a laudantium adipisci dolorem enim ipsum cum molestias? Quod quae molestias modi fugiat quisquam.
                    Eligendi recusandae officiis debitis quas beatae aliquam?</p>
            ...
            <div class="ftco-testimonial-1">
                ...
                <div>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque, mollitia. Possimus mollitia
                        nobis libero quidem aut tempore dolore iure maiores, perferendis, provident numquam illum nisi
                        amet necessitatibus. A, provident aperiam!</p>
                </div>
            </div>
